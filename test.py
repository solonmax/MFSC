...
results_folder = "./ckpt_universal/diffuir_msfsca"

dataset = AlignedDataset_all(opt, image_size, augment_flip=False, equalizeHist=True, crop_patch=False, generation=False, task='rain')
num_unet = 1
objective = 'pred_res'
...
if not trainer.accelerator.is_local_main_process:
    ...
    trainer.load(300)
    trainer.set_results_folder('./result10e-6')
